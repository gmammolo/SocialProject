            ...
            <section id="portfolio" class="two">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="4u">
                            <article class="item">
                                <a href="#" class="image fit"><img src="Template/images/pic02.jpg" alt="" /></a>
                                <header>
                                    <h3>Ipsum Feugiat</h3>
                                </header>
                            </article>
                        ...
                        <div class="4u">
                            <article class="item">
                                <a href="#" class="image fit"><img src="Template/images/pic04.jpg" alt="" /></a>
                                <header>
                                    <h3>Magna Nullam</h3>
                                </header>
                            </article>
                            <article class="item">
                                <a href="#" class="image fit"><img src="Template/images/pic05.jpg" alt="" /></a>
                                <header>
                                    <h3>Natoque Vitae</h3>
                                </header>
                            </article>
